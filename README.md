...
The agent is trained on the **DeepMind Control Suite (Cheetah Run)** under strict GPU memory constraints.
...
- **Hardware Constraints**  
  Can a **visual CNN + off-policy replay buffer** fit within **6GB of GPU VRAM**?
